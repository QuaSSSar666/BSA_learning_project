...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Entity detection (Выявление сущностей)](#3) \
    2.2. [Exercise 01 — Entity validation by CRUD (Проверка сущности по CRUD)](#4) \
    2.3. [Exercise 02 — Building a data dictionary (Построение словаря данных)](#5) \
    2.4. [Exercise 03 — Building a logical data model (Построение логической модели данных)](#6)
...
### Exercise 00 — Entity detection (Выявление сущностей) <div id="3"></div>
**Для каждой задачи:**
...
### Exercise 01 — Entity validation by CRUD (Проверка сущности по CRUD) <div id="4"></div>
**Для задачи 1:**
...
### Exercise 02 — Building a data dictionary (Построение словаря данных) <div id="5"></div>
**Для каждой задачи:**
...
### Exercise 03 — Building a logical data model (Построение логической модели данных) <div id="6"></div>
**Для каждой задачи:**
