...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Role-playing game (Ролевая игра)](#3) \
    2.2. [Exercise 01 — Brainstorming (Проведение мозгового штурма)](#4) \
    2.3. [Exercise 02 — Seminar (Семинар)](#5) \
    2.4. [Exercise 03 — Vision (Видение)](#6)
...
### Exercise 00 — Role-playing game (Ролевая игра) <div id="3"></div>
**Для задачи 2 нужно:**
...
### Exercise 01 — Brainstorming (Проведение мозгового штурма) <div id="4"></div>
**Для задачи 2 нужно:**
...
### Exercise 02 — Seminar (Семинар) <div id="5"></div>
**Для задачи 2 нужно:**
...
### Exercise 03 — Vision (Видение) <div id="6"></div>
**Для задачи 2 нужно:**
