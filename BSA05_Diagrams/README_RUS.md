...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Building DFD, level 0 (Построение диаграммы потоков данных, уровень 0)](#3) \
    2.2. [Exercise 01 — Building a Swimlane diagram (Построение диаграммы «плавательные дорожки»](#4) \
    2.3. [Exercise 02 — Addition a Swimlane diagram (Дополнение диаграммы «плавательные дорожки»)](#5) \
    2.4. [Exercise 03 — State diagram (Диаграмма состояний)](#6) \
    2.5. [Exercise 04 — State table (Таблица состояний)](#7)
...
### Exercise 00 — Building DFD, level 0 (Построение диаграммы потоков данных, уровень 0) <div id="3"></div>
...
### Exercise 01 — Building a Swimlane diagram (Построение диаграммы «плавательные дорожки») <div id="4"></div>
**Для каждой задачи:**
...
### Exercise 02 — Addition a Swimlane diagram (Дополнение диаграммы «плавательные дорожки») <div id="5"></div>
...
### Exercise 03 — State diagram (Диаграмма состояний) <div id="6"></div>
**Для каждой задачи:**
...
### Exercise 04 — State table (Таблица состояний) <div id="7"></div>
