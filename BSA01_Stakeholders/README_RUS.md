...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Identification of stakeholders (Выявление заинтересованных сторон)](#3) \
    2.2. [Exercise 01 — Building a Stakeholder Onion Diagram (Построение луковичной диаграммы)](#4) \
    3.3. [Exercise 02 — Interests, needs, problems of stakeholders (Интересы, потребности, проблемы заинтересованных сторон)](#5) \
    4.4. [Exercise 03 — Building a glossary (Наполнение глоссария)](#6)
...
### Exercise 00 — Identification of stakeholders (Выявление заинтересованных сторон) <div id="3"></div>
**Для задачи 2:**
...
### Exercise 01 — Building a Stakeholder Onion Diagram (Построение луковичной диаграммы) <div id="4"></div>
**Для задачи 2:**
...
### Exercise 02 — Interests, needs, problems of stakeholders (Интересы, потребности, проблемы заинтересованных сторон) <div id="5"></div>
**Для каждой задачи:**
...
### Exercise 03 — Building a glossary (Наполнение глоссария) <div id="6"></div>
**Для каждой задачи:**
