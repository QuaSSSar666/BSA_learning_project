...
2. [Chapter II](#chapter-ii) \
    2.1. [Exercise 00 — Creating a workspace (Создание пространства)](#3) \
    2.2. [Exercise 01 — Identifying information sources (Выявление источников информации)](#4) \
    2.3. [Exercise 02 — Creating and maintaining a glossary (Создание и ведение глоссария)](#5) \
    2.4. [Exercise 03 — Concept of Decomposition (Основные понятия декомпозиции)](#6) \
    2.5. [Exercise 04 — Types of Decomposition (Виды декомпозиции)](#7) \
    2.6. [Exercise 05 — Types of Decomposition (Виды декомпозиции)](#8) \
    2.7. [Exercise 06 — Decomposition Rules (Правила декомпозиции)](#9)
...
### Exercise 00 — Creating a workspace (Создание пространства) <div id="3"></div>
**Для каждой задачи**:
...
### Exercise 01 — Identifying information sources (Выявление источников информации) <div id="4"></div>
**Для каждой задачи:**
...
### Exercise 02 — Creating and maintaining a glossary (Создание и ведение глоссария) <div id="5"></div>
**Для каждой задачи:**
...
### Exercise 03 — Concept of Decomposition (Основные понятия декомпозиции) <div id="6"></div>
...
### Exercise 04 — Types of Decomposition (Виды декомпозиции) <div id="7"></div>
**Меню завтрака:** вареное яйцо, тост с маслом, сок, чай.

1. <a name="_heading=h.4i7ojhp"></a>Рассмотри декомпозицию завтрака на рисунке:
...
### Exercise 05 — Types of Decomposition (Виды декомпозиции) <div id="8"></div>
**Для задачи 2:**
...
### Exercise 06 — Decomposition Rules (Правила декомпозиции) <div id="9"></div>
**Активности дня:**
