...
2. [Chapter II](#chapter-ii) \
    ...
    2.2. [Exercise 01 — Creating a context diagram (Создание контекстной диаграммы)	12](#4) \
    2.3. [Exercise 02 — Solving the problems of stakeholders (Разрешение проблем стейкхолдеров)](#5) \
    2.4. [Exercise 03 — Check of input and output streams (Проверка входных/выходных потоков данных)](#6) \
    2.5. [Exercise 04 — Adding artifacts (Дополнение артефактов)](#6)
...
### Exercise 00 — Roles and their activities as is (Роли и их действия as is) <div id="3"></div>
**Для каждой задачи:** 
...
### Exercise 01 — Creating a context diagram (Создание контекстной диаграммы) <div id="4"></div>
**Для задачи 2:**
...
### Exercise 02 — Solving the problems of stakeholders (Разрешение проблем стейкхолдеров) <div id="5"></div>
**Для каждой задачи:**
...
### Exercise 04 — Adding artifacts (Дополнение артефактов) <div id="6"></div>
**Для каждой задачи:**
